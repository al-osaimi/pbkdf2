...
static void sha256_update(SHA256_CTX *ctx, const uint8_t *m, uint32_t mlen);
// resets state: calls sha256_init
static void sha256_final(SHA256_CTX *ctx, uint8_t *md);
...
static void hmac_sha256_init(HMAC_SHA256_CTX *hmac, const uint8_t *key, uint32_t keylen);
static void hmac_sha256_update(HMAC_SHA256_CTX *hmac, const uint8_t *m, uint32_t mlen);
// resets state to hmac_sha256_init
static void hmac_sha256_final(HMAC_SHA256_CTX *hmac, uint8_t *md);

static void pbkdf2_sha256(HMAC_SHA256_CTX *ctx,
...
static void sha256_final(SHA256_CTX *s, uint8_t *md)
{
...
static void sha256_update(SHA256_CTX *s, const uint8_t *m, uint32_t len)
{
	const uint8_t *p = m;
	uint32_t r = s->len % SHA256_BLOCKLEN;
...
static void pbkdf2_sha256(HMAC_SHA256_CTX *hmac,
    const uint8_t *key, uint32_t keylen, const uint8_t *salt, uint32_t saltlen, uint32_t rounds,
    uint8_t *dk, uint32_t dklen)
{
